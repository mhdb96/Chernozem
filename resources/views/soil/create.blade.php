...
@section('content-description', 'Yeni Toprak Türleri Ekle')
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Yeni Toprak Türleri Ekle</h3>
        </div>

        <form class="form-horizontal" action="{{ route('soil.store') }}" method="POST">
          @csrf
          <div class="box-body">
            ...
            <div class="col-sm-12 input-box" id="group_1">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="fertility[]" id="fertility" placeholder="Toprak Verimliliği">
                </div>
