...
<body class="hold-transition register-page" cz-shortcut-listen="true" style="background: url({{ asset('dist/img/bac.jpg') }}) no-repeat center center/cover;">
<div class="register-box">
  <div class="register-logo" style="font-weight: 400;color:white;">
...
@endif
    <form action="{{ route('register') }}" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Üye ol</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
